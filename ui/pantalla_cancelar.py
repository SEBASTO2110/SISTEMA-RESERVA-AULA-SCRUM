...
class PantallaCancelar:
    def __init__(self, parent, db):
        ...
        self.ventana.geometry(f"650x650+{x}+{y}")
    ...
    def crear_interfaz(self):
        ...
        frame_entrada = tk.Frame(frame, bg="#ffffff")
        frame_entrada.pack(fill="x", pady=(0, 10))
        
        self.var_fecha_busqueda = tk.StringVar()
        entry_fecha = tk.Entry(frame_entrada, textvariable=self.var_fecha_busqueda, width=35, font=("Arial", 10))
        entry_fecha.pack(side="left", fill="x", expand=True)
        
        tk.Button(frame_entrada, text="🔍 Buscar", bg="#3498db", fg="white", 
                font=("Arial", 10, "bold"), command=self.cargar_reservas, width=8).pack(side="left", padx=(5, 0))
    ...
    def cargar_reservas(self):
        ...
        try:
            ...
            self.listbox.insert(0, f"Error: {str(e)}")
